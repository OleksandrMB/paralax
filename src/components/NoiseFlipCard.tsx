...
const NoiseFlipCard = ({
  ...
  return large ? (
    <div
      className={`group card h-[357px] md:h-[369px]"
    ...
    >
      <div className="z-20 h-[400px] lg:h-[369px] pt-[130px] px-[20px] md:px-[70px]">
        <h1 className="group-hover:invisible text-[#222] text-[28px] services-1430:text-[34px] text-center">
          {title}
        </h1>
