  ...
  return (
    <div className="flex justify-between flex-col lg:flex-row ">
      <div className="order-2 h-full  lg:order-1 lg:mt-[109px] mt-[20px] mr-[25px]">
        ...
        /> */}
        <div className="lg:mt-[75px]  flex flex-col justify-between">
          ...
          <div className="flex flex-col md:flex-row gap-[20px] md:gap-[20px] lg:gap-[18px] img-SmBreakPoint:ml-[35px] mt-[60px] md:mt-[25px] lg:justify-start justify-center mr-[30px] md:mr-[0] home-1108:static img-SmBreakPoint:absolute img-SmBreakPoint:top-[730px]">
