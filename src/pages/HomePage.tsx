    ...
    <div className="flex justify-between w-full">
      <div className="mt-[109px]">
        <img
          ...
          className="w-[622px] h-[692px] absolute bottom-[0px] right-[180px] z-10"
        />
        <div className="ml-[70px] mt-[75px]">
          <div className="flex flex-col gap-[63.57px]">
            <h1 className="custom-md:text-[58px] font-epilogue-font font-bold text-black-900 uppercase text-[40px] leading-120 z-20">
