...
const CompanyHighlights = () => {
  return (
    ...
    >
      <div className="ml-[15px] md:ml-[30px] lg:ml-[60px] text-white flex flex-col gap-[27px] mt-[25px] qualityCards-betwen:mt-[47px] mb-[40px]">
      ...
      <div className="md:ml-[30px] lg:ml-[60px]">
        <QualityCards />
      </div>
